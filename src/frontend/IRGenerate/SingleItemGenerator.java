 ...
 */
public class SingleItemGenerator extends SequenceGenerator {
        ...
        public void inject() {
            ...
            inject(Assign.class, assign -> {
                ...
                if(lValResult instanceof LValGenerator.IntPointerResult){
                    addSequence(new Store(((LValGenerator.IntPointerResult) lValResult).addressValue, expResult));
                }else{
                    addSequence(new Assignment(((LValGenerator.LValueResult) lValResult).lVal, expResult));
                }
            });
            ...
            inject(GetIntNode.class, getint->{
                ...
                if(result instanceof LValGenerator.IntPointerResult){
                    ...
                    addSequence(new GetInt(temp));
                    addSequence(new Store(((LValGenerator.IntPointerResult) result).addressValue, temp));
                }else{
                    addSequence(new GetInt(((LValGenerator.LValueResult) result).lVal));
                }
            });
            ...
            inject(PrintfNode.class, printf->{
                ...
                for(FormatString.Char c : formatString.getCharList()){
                    if(c instanceof FormatString.NormalChar){
                        ...
                        if(str != null){
                            addSequence(new PrintString(str.toString()));
                            str = null;
                        }
                        addSequence(new PrintInt(iterator.next()));
                    }
                }
                if(str != null){
                    addSequence(new PrintString(str.toString()));
